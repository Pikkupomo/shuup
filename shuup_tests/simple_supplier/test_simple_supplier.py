...
from shuup.core.models import ShippingMode, StockBehavior, Product, Supplier, Order, Shipment
...
@pytest.mark.django_db
@pytest.mark.parametrize("stock_behavior, shipping_mode, stock_managed, expect_errors", [
    (StockBehavior.UNSTOCKED, ShippingMode.SHIPPED, True, True),
    (StockBehavior.UNSTOCKED, ShippingMode.NOT_SHIPPED, True, True),
    (StockBehavior.UNSTOCKED, ShippingMode.NOT_SHIPPED, False, True),
    (StockBehavior.STOCKED, ShippingMode.SHIPPED, True, True),
    (StockBehavior.STOCKED, ShippingMode.NOT_SHIPPED, True, True),
    (StockBehavior.STOCKED, ShippingMode.NOT_SHIPPED, False, True),
])
def test_supplier_with_stock_counts(rf, stock_managed, shipping_mode, stock_behavior, expect_errors):
    ...
    product.stock_behavior = stock_behavior  # Will deprecate
    product.save()
...
@pytest.mark.django_db
@pytest.mark.parametrize("stock_behavior, shipping_mode, stock_managed, is_orderable", [
    (StockBehavior.UNSTOCKED, ShippingMode.SHIPPED, True, True),
    (StockBehavior.UNSTOCKED, ShippingMode.NOT_SHIPPED, True, True),
    (StockBehavior.UNSTOCKED, ShippingMode.NOT_SHIPPED, False, True),
    (StockBehavior.STOCKED, ShippingMode.SHIPPED, True, True),
...
def test_supplier_with_shipping_mode(settings, stock_behavior, shipping_mode, stock_managed, is_orderable):
    ...
    with override_settings(SHUUP_HOME_CURRENCY="USD", SHUUP_ENABLE_MULTIPLE_SHOPS=False):
        ...
        #     product = create_product("simple-test-product", shop, None, stock_behavior=stock_behavior,
        #                          shipping_mode=shipping_mode)

        product = create_product("simple-test-product", shop, supplier, stock_behavior=stock_behavior, shipping_mode=shipping_mode)
